...
// 所有文案 = 雪克在说话（docs/LAOK-PERSONA.md）
...
// intro = 出酒时雪克直接说的话（无舞台说明；酒名只在结果卡标题出现一次，intro 不重复报名）
const BASES = [
  {
...
if (typeof document !== "undefined" && document.getElementById("quiz")) {
  ...
  /* ---- 雪克 登场：像素立绘 + 三句自我引入（店名「99%」全站唯一一次自介） ---- */
  const HOST_LINES = [
    "来了？我是雪克，这店归我管。",
